...
import {fetchTournamentResults} from "@/src/services/resultsService";
...
export default async function Page({ params }: { params: { tournamentSlug: string } }) {
    ...
    return <Results results={results} tournament={{ slug: params.tournamentSlug, title: tournament.title }}/>
}
